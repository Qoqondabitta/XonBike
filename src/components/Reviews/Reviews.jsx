...
const REVIEWS = [
  { id: 1, name: 'Anna Wiśniewska', location: 'Kraków, Poland', avatar: 'AW', rating: 5, text: 'Amazing service! The bike was in perfect condition, fully charged, and the booking process took less than 5 minutes. Explored the whole city in a day. Absolutely worth every złoty!', date: 'March 2025' },
  { id: 2, name: 'Marco Bianchi',    location: 'Milan, Italy',   avatar: 'MB', rating: 5, text: "I was visiting Poland as a tourist and this was the best decision I made. The e-bike was top-quality and the owner responded instantly on WhatsApp. I'll definitely rent again next visit!", date: 'February 2025' },
  { id: 3, name: 'Tomasz Kowalski', location: 'Wrocław, Poland', avatar: 'TK', rating: 5, text: 'Very easy rental process and the bike performed flawlessly. Battery lasted the entire day without needing a charge. Perfect for exploring the city — much better than public transport.', date: 'January 2025' },
  { id: 4, name: 'Sophie Müller',   location: 'Berlin, Germany', avatar: 'SM', rating: 5, text: 'Incredible experience! The bike was clean, fast, and comfortable. The owner even gave us local tips on the best scenic routes. Highly recommend to anyone visiting Poland!', date: 'April 2025' },
  { id: 5, name: 'Piotr Nowak',     location: 'Warsaw, Poland',  avatar: 'PN', rating: 5, text: 'Rented for 3 days and loved every minute. Great value for money, premium bike quality, and the customer support was exceptional. This is how bike rentals should be done!', date: 'March 2025' },
];
      ...
      <div className="container">
        <div className="reviews__header fade-up" ref={headerRef}>
          ...
          <h2 className="section-title">
            {t('reviews.title')} <span className="accent-text">{t('reviews.titleAccent')}</span>
          </h2>
        ...
        >
          <div className="reviews__card" key={active} aria-live="polite">
            <div className="reviews__card-top">
              ...
              <div className="reviews__google-badge"><span>G</span></div>
            </div>

            <StarRating count={current.rating} />

            <blockquote className="reviews__text">"{current.text}"</blockquote>
